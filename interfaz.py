...
from parserC import analizarSintactico
from lexerC import analizarLexico
...
class Ventana:
    ...
    def __init__(self, root):
        ...
        self.titulo = tk.Label(
            root, text="Analizador Léxico y Sintáctico de C++")
        ...
        self.buttonLexico = tk.Button(
            root, text="Analizar Léxico", command=self.analizarLexico)
        ...
        self.buttonSintactico = tk.Button(
            root, text="Analizar Sintáctico", command=self.analizarSintactico)
